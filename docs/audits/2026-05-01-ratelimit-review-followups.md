...
| T1  | `enforceRateLimits` Promise.all → sequence per-device → per-user; log on partial drain | Warning (bug/UX)      | 85    | [#51](https://github.com/librito-io/web/pull/51) | in-review                  | 2026-05-01   |
