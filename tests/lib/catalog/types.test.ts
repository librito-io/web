...
function makePositive(): PositiveBookCatalogRow {
  return {
    ...
    publisher_attempted_at: null,
    publisher_attempts: 0,
    publisher_fail_reason: null,
    publisher_provider: null,
    published_date_attempted_at: null,
    published_date_attempts: 0,
    published_date_fail_reason: null,
    published_date_provider: null,
    subjects_attempted_at: null,
    subjects_attempts: 0,
    subjects_fail_reason: null,
    subjects_provider: null,
    page_count_attempted_at: null,
    page_count_attempts: 0,
    page_count_fail_reason: null,
    page_count_provider: null,
